# This Makefile is for the PGObject::Util::Replication::SMO extension to perl.
#
...
#     PL_FILES => {  }
#     PREREQ_PM => { Test::Exception=>q[0], Test::More=>q[0], PGObject::Util::PGConfig=>q[0], DBD::Pg=>q[3], DBI=>q[1], Moo=>q[1], PGObject::Util::Replication::Slot=>q[0] }
#     TEST_REQUIRES => {  }
...
MAKE = make
FULLEXT = PGObject/Util/Replication/SMO
BASEEXT = SMO
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/PGObject/Util/Replication/SMO.pm
...
TO_INST_PM = lib/PGObject/Util/Replication/SMO.pm

PM_TO_BLIB = lib/PGObject/Util/Replication/SMO.pm \
...
DISTVNAME = PGObject-Util-Replication-SMO-0.03
...
manifypods : pure_all  \
	lib/PGObject/Util/Replication/SMO.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/PGObject/Util/Replication/SMO.pm $(INST_MAN3DIR)/PGObject::Util::Replication::SMO.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Replication Server Management Objects!'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: PGObject-Util-Replication-SMO' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Replication Server Management Objects!",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "PGObject-Util-Replication-SMO",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Replication Server Management Objects!</ABSTRACT>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="DBI::" VERSION="1" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/PGObject/Util/Replication/SMO.pm blib/lib/PGObject/Util/Replication/SMO.pm 
